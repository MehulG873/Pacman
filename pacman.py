...
class Pacman:
    def __init__(self, app, pos):
        ...
        self.spriteCount = 0
        self.spriteImages = [
                             self.app.scaleImage(self.app.loadImage('SpriteSheet.png').crop((20, 91, 32, 104)), 2.8),
                             self.app.scaleImage(self.app.loadImage('SpriteSheet.png').crop((35, 91, 44, 104)), 2.8),
                             self.app.scaleImage(self.app.loadImage('SpriteSheet.png').crop((48, 91, 60, 104)), 2.8),
                             self.app.scaleImage(self.app.loadImage('SpriteSheet.png').crop((63, 91, 72, 104)), 2.8),
                             self.app.scaleImage(self.app.loadImage('SpriteSheet.png').crop((76, 91, 89, 104)), 2.8),
                             self.app.scaleImage(self.app.loadImage('SpriteSheet.png').crop((93, 91, 106, 104)), 2.8),
                             self.app.scaleImage(self.app.loadImage('SpriteSheet.png').crop((110, 91, 123, 104)), 2.8),
